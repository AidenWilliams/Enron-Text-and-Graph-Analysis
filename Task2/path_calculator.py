...
def build_paths(graph, paths, origin, v2=None, p_length=1, seen=None, looping=False):
    if seen is None:
        seen = set()
    ...
    for vertex in connected_to_v1:
        ...
        # If the vertex hasn't been visited yet, or isn't defined as an end vertex
            ...
            if vertex not in finished or b:
                ...
                # looping is updated
                build_paths(graph, paths, origin, v2=vertex, p_length=p_length + 1, seen=seen, looping=b)
